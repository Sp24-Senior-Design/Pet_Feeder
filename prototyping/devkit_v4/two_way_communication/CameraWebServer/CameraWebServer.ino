...
// For communication between 2 ESPs using the ESP-NOW protocol
#include <esp_now.h>

uint8_t broadcastAddress[] = {0xA0, 0xA3, 0xB3, 0x8B, 0x40, 0x4C}; //--> REPLACE WITH THE MAC Address of your receiver (ESP-DevKitC V4).
...
// Setup LED FLash if LED pin is defined in camera_pins.h
  ...
  // SET UP FOR ESP-NOW COMMUNICATION ==================================================================================================================
...
void loop() {
  // LOOP FOR ESP-NOW COMMUNICATION =======================================================================================================================
  //----------------------------------------Set values to send

...
#else
  String MACadd = "AC:67:B2:1B:DA:54"; // This only for printing
  uint8_t address[6]  = {0xAC, 0x67, 0xB2, 0x1B, 0xDA, 0x54}; // Change this to reflect real MAC address of your slave BT device
#endif

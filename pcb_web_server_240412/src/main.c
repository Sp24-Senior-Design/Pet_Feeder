...
void init_time() {
  ...
  time(&now);
  localtime_r(&now, &timeinfo);
  while (timeinfo.tm_year < (2016 - 1900)) { // check if time is already correct
    obtain_time();
    time(&now);
...
void configTime(const char* server1)
{
    ...
    esp_sntp_setservername(1, (char*)server1);
    esp_sntp_setservername(2, (char*)server1);
    esp_sntp_init();
...
void getTime() {
  ...
  // store time info
  // strftime(timeHour,10, "%I", &timeinfo); // hour
  ...
  // convert timeHour into int and translate for our time zone
  // int timeHourInt = ((int) (timeHour[0] - '0')) * 10 + ((int) (timeHour[1] - '0'));
  // timeHourInt -= 8; // time zone conversion
  // if (timeHourInt <= 0) {
  //   timeHourInt += 12;
  // } else if (timeHourInt > 12) {
  //   timeHourInt -= 12;
  // }
  // ESP_LOGI(TAG, "timeHourInt: %d", timeHourInt);
  ...
  // if (timeHourInt == 9) {
  //   idHour = 0;
  // } else if (timeHourInt == 10) {
  //   idHour = 1;
  // } else if (timeHourInt == 11) {
  //   idHour = 2;
  // } else if (timeHourInt == 12) {
  //   idHour = 3;
  // } else if (timeHourInt == 1) {
  //   idHour = 4;
  // } else if (timeHourInt == 2) {
  //   idHour = 5;
  // } else if (timeHourInt == 3) {
  //   idHour = 6;
  // } else if (timeHourInt == 4) {
  //   idHour = 7;
  // } else if (timeHourInt == 5) {
  //   idHour = 8;
  // } else if (timeHourInt == 6) {
  //   idHour = 9;
  // } else {
  //   idHour = -1;
  // }

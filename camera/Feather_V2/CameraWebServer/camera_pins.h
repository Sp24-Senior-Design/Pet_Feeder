...
/* FEATHER-V2 PIN CONFIGURATIONS */
#define PWDN_GPIO_NUM     32 // not used, blank GPIO pin
#define RESET_GPIO_NUM    -1
#define XCLK_GPIO_NUM     15 // GPIO0 is connected to the NeoPixel
#define SIOD_GPIO_NUM     22
#define SIOC_GPIO_NUM     20
